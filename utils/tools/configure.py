...
from utils.tools.tool import Args
...
class Configure(object):
    ...
    def get_file_cfg(file):
        ...
        """
        cfgargs = Args()
        ## Here we use the "configparser.ConfigParser()" to parse the file
    ...
    def get_console_cfg(default_file):
        ...
        ## Here we use the "argparse.ArgumentParser()" to parse the configs from both consoel and _console_.cfg config file
        ...
        ## This loop which uses setattr(,,getattr) will omit all the None attributes.
        for arg_name, arg in args_label:
    ...
    @staticmethod
    def Get():
        ## Here we read in the cfg filenme from the console, while other args doesn't really matters.
